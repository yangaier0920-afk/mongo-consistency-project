"""Offline regression tests: python -m unittest experiments.test_consistency -v."""
import subprocess
import json
import tempfile
import unittest
...
class FaultTests(unittest.TestCase):
    ...
    @patch('experiments.faults.inspect_container')
    @patch('experiments.faults.docker')
    ...
    @patch('experiments.faults.subprocess.run')
...
class RunnerFailureTests(unittest.TestCase):
    ...
    def test_mid_run_fault_error_preserves_evidence_and_attempts_recovery(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch('experiments.run.MongoClient') as mongo, \
                 patch('experiments.run.wait_ready', return_value=states), \
                 patch('experiments.run.FaultController') as factory, \
                 patch('experiments.run.Workload') as workload, \
